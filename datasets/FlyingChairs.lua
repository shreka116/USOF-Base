...
function FlyingChairsDataset:preprocess()
   if self.split == 'train' then
         return t.SelectTransform{
            ...
            t.Rotation_wo_blacks_init(17),
            t.Scales_wo_blacks(0.9, 2),
            t.Translations_wo_blacks(0.15),

            -- relative augmentation
            t.Rotation_wo_blacks_relative(3),
            t.Scales_wo_blacks_relative(1, 1.1),
            t.Translations_wo_blacks_relative(0.03),
